...
ArbolBinario cargarArbol(char *tipo)
{
    ...
    printf("Ingrese el tipo de elementos a cargar (n: números, l: letras): ");
    while (1)
    {
        scanf(" %c", tipo);
        if (*tipo == 'n' || *tipo == 'l') // Desreferenciando el puntero
        {
            break;
        }
        else
        {
            printf("Tipo inválido. Ingrese nuevamente (n: números, l: letras): ");
        }
    }
